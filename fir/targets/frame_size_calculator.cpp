...
void fir::frame_size_calculator::do_mem_alloc_node(fir::mem_alloc_node *const node, int lvl) {
  // EMPTY
}
...
void fir::frame_size_calculator::do_block_node(fir::block_node *const node, int lvl) {
  if (node->decl()) node->decl()->accept(this, lvl + 2);
  if (node->inst()) node->inst()->accept(this, lvl + 2);
}
...
void fir::frame_size_calculator::do_while_do_node(fir::while_do_node *const node, int lvl) {
  node->block()->accept(this, lvl + 2);
}

void fir::frame_size_calculator::do_while_do_finally_node(fir::while_do_finally_node *const node, int lvl) {
  node->block()->accept(this, lvl + 2);
  node->finally()->accept(this, lvl + 2);
}

void fir::frame_size_calculator::do_variable_decl_node(fir::variable_decl_node *const node, int lvl) {
